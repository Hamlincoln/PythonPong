...
pygame.display.set_caption("Pong_2.0")
run =  True
player_1 = player_2 = 0
direction = [0, 1]
angle = [0, 1, 2]
...
while run: 
    ...
    #OBJECTS
    pygame.draw.circle(wn, PURPLE, (ball_x, ball_y), radius)
    pygame.draw.rect(wn, RED, pygame.Rect(left_paddle_x, left_paddle_y, paddle_width, paddle_height))
    pygame.draw.rect(wn, RED, pygame.Rect(right_paddle_x, right_paddle_y, paddle_width, paddle_height))

    # dummy ball section 
    pygame.draw.circle(wn, PURPLE, (dummy_ball_x, dummy_ball_y), radius)
